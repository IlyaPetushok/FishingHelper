...
public class PhotoController {
    ...
    @PostMapping("/photo/public-url")
    public ResponseEntity<?> uploadPublicUrl(@RequestBody PhotoDTO photoDTO){
        return new ResponseEntity<>(fileSenderYandexCloudService.createPublicLink(photoDTO.getPath()),HttpStatus.OK);
    }
}
